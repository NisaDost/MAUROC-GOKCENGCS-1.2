...
namespace GCS_Node.Nav
{
    ...
    internal unsafe partial class OccupancyGrid : global::Rosidl.Runtime.IMessage
    {
        ...
        public OccupancyGrid(
            ...
            global::GCS_Node.Nav.MapMetaData? @info = null,
            sbyte[]? @data = null
        )
        {
            Header = @header ?? new global::GCS_Node.Std.Header();
            İnfo = @info ?? new global::GCS_Node.Nav.MapMetaData();
        ...
        public OccupancyGrid(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.İnfo = new global::GCS_Node.Nav.MapMetaData(in priv.İnfo, textEncoding);
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::GCS_Node.Nav.MapMetaData İnfo { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[nav_msgs/msg/MapMetaData info]]></c>
            /// </remarks>
            public global::GCS_Node.Nav.MapMetaData.Priv İnfo;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::GCS_Node.Nav.OccupancyGrid.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::GCS_Node.Nav.OccupancyGrid.PrivSequence.{caller}'.");
                }
            }
        }
    }
