    ...
    internal unsafe partial class TwistWithCovariance : global::Rosidl.Runtime.IMessage
    {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            public global::System.Span<double> Covariance
            {
                get
                {
                    fixed (global::GCS_Node.Geometry.TwistWithCovariance.Priv* __p = &this) return new (__p->__Covariance, 36);
                }
            }
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::GCS_Node.Geometry.TwistWithCovariance.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::GCS_Node.Geometry.TwistWithCovariance.PrivSequence.{caller}'.");
                }
            }
        }
    }
