...
namespace GCS_Node.Geometry
{
    ...
    internal unsafe partial class InertiaStamped : global::Rosidl.Runtime.IMessage
    {
        ...
        public InertiaStamped(
            ...
            global::GCS_Node.Geometry.Inertia? @inertia = null
        )
        {
            Header = @header ?? new global::GCS_Node.Std.Header();
            İnertia = @inertia ?? new global::GCS_Node.Geometry.Inertia();
        }
        ...
        public InertiaStamped(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.İnertia = new global::GCS_Node.Geometry.Inertia(in priv.İnertia, textEncoding);
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::GCS_Node.Geometry.Inertia İnertia { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Inertia inertia]]></c>
            /// </summary>
            public global::GCS_Node.Geometry.Inertia.Priv İnertia;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::GCS_Node.Geometry.InertiaStamped.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::GCS_Node.Geometry.InertiaStamped.PrivSequence.{caller}'.");
                }
            }
        }
    }
