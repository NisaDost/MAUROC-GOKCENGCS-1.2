...
namespace GCS_Node.Rcl
{
    ...
    internal unsafe partial class Parameter : global::Rosidl.Runtime.IMessage
    {
        ...
        public Parameter(
            string @name = "",
            global::GCS_Node.Rcl.ParameterValue? @value = null
        )
        {
            Name = @name;
            Value = @value ?? new global::GCS_Node.Rcl.ParameterValue();
        }
        ...
        public Parameter(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Value = new global::GCS_Node.Rcl.ParameterValue(in priv.Value, textEncoding);
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::GCS_Node.Rcl.ParameterValue Value { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[rcl_interfaces/msg/ParameterValue value]]></c>
            /// </remarks>
            public global::GCS_Node.Rcl.ParameterValue.Priv Value;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::GCS_Node.Rcl.Parameter.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::GCS_Node.Rcl.Parameter.PrivSequence.{caller}'.");
                }
            }
        }
    }
