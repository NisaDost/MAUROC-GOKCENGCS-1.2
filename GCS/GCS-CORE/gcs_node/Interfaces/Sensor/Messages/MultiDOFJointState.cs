...
namespace GCS_Node.Sensor
{
    ...
    internal unsafe partial class MultiDOFJointState : global::Rosidl.Runtime.IMessage
    {
        ...
        public MultiDOFJointState(
            ...
            global::GCS_Node.Geometry.Twist[]? @twist = null,
            global::GCS_Node.Geometry.Wrench[]? @wrench = null
        )
        {
            ...
            Twist = @twist ?? global::System.Array.Empty<global::GCS_Node.Geometry.Twist>();
            Wrench = @wrench ?? global::System.Array.Empty<global::GCS_Node.Geometry.Wrench>();
        }
        ...
        public MultiDOFJointState(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Twist = new global::GCS_Node.Geometry.Twist[priv.Twist.Size];
            var Twist_span = priv.Twist.AsSpan();
            for (int __i = 0; __i < this.Twist.Length; __i++)
            {
                this.Twist[__i] = new global::GCS_Node.Geometry.Twist(in Twist_span[__i], textEncoding);
            }
        
            this.Wrench = new global::GCS_Node.Geometry.Wrench[priv.Wrench.Size];
            var Wrench_span = priv.Wrench.AsSpan();
            for (int __i = 0; __i < this.Wrench.Length; __i++)
            {
                this.Wrench[__i] = new global::GCS_Node.Geometry.Wrench(in Wrench_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::GCS_Node.Geometry.Twist[] Twist { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::GCS_Node.Geometry.Wrench[] Wrench { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Twist = new global::GCS_Node.Geometry.Twist.PrivSequence(this.Twist.Length);
            var Twist_span = priv.Twist.AsSpan();
            for (int __i = 0; __i < this.Twist.Length; __i++)
            {
            ...
            priv.Wrench = new global::GCS_Node.Geometry.Wrench.PrivSequence(this.Wrench.Length);
            var Wrench_span = priv.Wrench.AsSpan();
            for (int __i = 0; __i < this.Wrench.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Twist[] twist]]></c>
            /// </summary>
            public global::GCS_Node.Geometry.Twist.PrivSequence Twist;
            
            /// <summary>
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Wrench[] wrench]]></c>
            /// </summary>
            public global::GCS_Node.Geometry.Wrench.PrivSequence Wrench;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::GCS_Node.Sensor.MultiDOFJointState.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::GCS_Node.Sensor.MultiDOFJointState.PrivSequence.{caller}'.");
                }
            }
        }
    }
