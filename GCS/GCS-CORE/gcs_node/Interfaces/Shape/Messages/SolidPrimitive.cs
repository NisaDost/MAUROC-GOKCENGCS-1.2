...
namespace GCS_Node.Shape
{
    ...
    internal unsafe partial class SolidPrimitive : global::Rosidl.Runtime.IMessage
    {
        ...
        public SolidPrimitive(
            ...
            global::GCS_Node.Geometry.Polygon? @polygon = null
        )
        {
            Type = @type;
            Dimensions = @dimensions ?? global::System.Array.Empty<double>();
            Polygon = @polygon ?? new global::GCS_Node.Geometry.Polygon();
        }
        ...
        public SolidPrimitive(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Polygon = new global::GCS_Node.Geometry.Polygon(in priv.Polygon, textEncoding);
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::GCS_Node.Geometry.Polygon Polygon { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Polygon polygon]]></c>
            /// </summary>
            public global::GCS_Node.Geometry.Polygon.Priv Polygon;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::GCS_Node.Shape.SolidPrimitive.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::GCS_Node.Shape.SolidPrimitive.PrivSequence.{caller}'.");
                }
            }
        }
    }
