...
namespace target_uav_id_publisher.Sensor
{
    ...
    internal unsafe partial class Range : global::Rosidl.Runtime.IMessage
    {
        ...
        /// <para>(originally defined as: <c><![CDATA[uınt8 radiation_type]]></c>)</para>
        /// </param>
        ...
        /// </summary>
        /// <remarks>
        /// Originally defined as: <c><![CDATA[uınt8 ULTRASOUND = 0]]></c>
        /// </remarks>
        public const byte ULTRASOUND = 0;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[uınt8 INFRARED = 1]]></c>
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// Originally defined as: <c><![CDATA[uınt8 radiation_type]]></c>
        /// </remarks>
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Sensor.Range.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Sensor.Range.PrivSequence.{caller}'.");
                }
            }
        }
    }
