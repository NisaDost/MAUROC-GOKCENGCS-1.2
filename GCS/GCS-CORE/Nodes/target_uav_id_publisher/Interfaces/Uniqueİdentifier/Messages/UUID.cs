...
namespace target_uav_id_publisher.Uniqueİdentifier
{
    /// <summary>
    ...
    internal unsafe partial class UUID : global::Rosidl.Runtime.IMessage
    {
        ...
        /// </summary>
        /// <param name='uuid'>
        /// Originally defined as: <c><![CDATA[uınt8[16] uuid]]></c>
        /// </param>
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public UUID(
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            public global::System.Span<byte> Uuid
            {
                get
                {
                    fixed (global::target_uav_id_publisher.Uniqueİdentifier.UUID.Priv* __p = &this) return new (__p->__Uuid, 16);
                }
            }
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Uniqueİdentifier.UUID.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Uniqueİdentifier.UUID.PrivSequence.{caller}'.");
                }
            }
        }
    }
