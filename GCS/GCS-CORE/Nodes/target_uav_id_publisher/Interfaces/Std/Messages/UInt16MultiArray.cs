...
namespace target_uav_id_publisher.Std
{
    ...
    internal unsafe partial class UInt16MultiArray : global::Rosidl.Runtime.IMessage
    {
        ...
        public UInt16MultiArray(
            global::target_uav_id_publisher.Std.MultiArrayLayout? @layout = null,
            ushort[]? @data = null
        )
        {
            Layout = @layout ?? new global::target_uav_id_publisher.Std.MultiArrayLayout();
        ...
        {
            this.Layout = new global::target_uav_id_publisher.Std.MultiArrayLayout(in priv.Layout, textEncoding);
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Std.MultiArrayLayout Layout { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[std_msgs/msg/MultiArrayLayout layout]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Std.MultiArrayLayout.Priv Layout;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Std.UInt16MultiArray.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Std.UInt16MultiArray.PrivSequence.{caller}'.");
                }
            }
        }
    }
