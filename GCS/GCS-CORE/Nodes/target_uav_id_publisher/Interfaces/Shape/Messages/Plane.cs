...
namespace target_uav_id_publisher.Shape
{
    ...
    internal unsafe partial class Plane : global::Rosidl.Runtime.IMessage
    {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            public global::System.Span<double> Coef
            {
                get
                {
                    fixed (global::target_uav_id_publisher.Shape.Plane.Priv* __p = &this) return new (__p->__Coef, 4);
                }
            }
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Shape.Plane.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Shape.Plane.PrivSequence.{caller}'.");
                }
            }
        }
    }
