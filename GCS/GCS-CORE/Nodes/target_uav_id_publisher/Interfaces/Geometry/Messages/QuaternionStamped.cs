...
namespace target_uav_id_publisher.Geometry
{
    ...
    internal unsafe partial class QuaternionStamped : global::Rosidl.Runtime.IMessage
    {
        ...
        public QuaternionStamped(
            ...
            global::target_uav_id_publisher.Geometry.Quaternion? @quaternion = null
        )
        {
            Header = @header ?? new global::target_uav_id_publisher.Std.Header();
            Quaternion = @quaternion ?? new global::target_uav_id_publisher.Geometry.Quaternion();
        }
        ...
        public QuaternionStamped(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Quaternion = new global::target_uav_id_publisher.Geometry.Quaternion(in priv.Quaternion, textEncoding);
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Geometry.Quaternion Quaternion { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Quaternion quaternion]]></c>
            /// </summary>
            public global::target_uav_id_publisher.Geometry.Quaternion.Priv Quaternion;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Geometry.QuaternionStamped.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Geometry.QuaternionStamped.PrivSequence.{caller}'.");
                }
            }
        }
    }
