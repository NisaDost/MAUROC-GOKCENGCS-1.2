    ...
    internal unsafe partial class PoseWithCovariance : global::Rosidl.Runtime.IMessage
    {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            public global::System.Span<double> Covariance
            {
                get
                {
                    fixed (global::target_uav_id_publisher.Geometry.PoseWithCovariance.Priv* __p = &this) return new (__p->__Covariance, 36);
                }
            }
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Geometry.PoseWithCovariance.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Geometry.PoseWithCovariance.PrivSequence.{caller}'.");
                }
            }
        }
    }
