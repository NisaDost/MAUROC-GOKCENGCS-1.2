...
namespace target_uav_id_publisher.Geometry
{
    ...
    internal unsafe partial class Vector3Stamped : global::Rosidl.Runtime.IMessage
    {
        ...
        public Vector3Stamped(
            ...
            global::target_uav_id_publisher.Geometry.Vector3? @vector = null
        )
        {
            Header = @header ?? new global::target_uav_id_publisher.Std.Header();
            Vector = @vector ?? new global::target_uav_id_publisher.Geometry.Vector3();
        }
        ...
        public Vector3Stamped(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Vector = new global::target_uav_id_publisher.Geometry.Vector3(in priv.Vector, textEncoding);
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Geometry.Vector3 Vector { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Vector3 vector]]></c>
            /// </summary>
            public global::target_uav_id_publisher.Geometry.Vector3.Priv Vector;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Geometry.Vector3Stamped.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Geometry.Vector3Stamped.PrivSequence.{caller}'.");
                }
            }
        }
    }
