...
namespace target_uav_id_publisher.Geometry
{
    ...
    internal unsafe partial class TransformStamped : global::Rosidl.Runtime.IMessage
    {
        ...
        public TransformStamped(
            ...
            string @childFrameİd = "",
            global::target_uav_id_publisher.Geometry.Transform? @transform = null
        )
        {
            Header = @header ?? new global::target_uav_id_publisher.Std.Header();
            ChildFrameİd = @childFrameİd;
            Transform = @transform ?? new global::target_uav_id_publisher.Geometry.Transform();
        }
        ...
        public TransformStamped(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Transform = new global::target_uav_id_publisher.Geometry.Transform(in priv.Transform, textEncoding);
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Geometry.Transform Transform { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Transform transform]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Geometry.Transform.Priv Transform;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Geometry.TransformStamped.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Geometry.TransformStamped.PrivSequence.{caller}'.");
                }
            }
        }
    }
