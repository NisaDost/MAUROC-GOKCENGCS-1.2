...
namespace target_uav_id_publisher.Visualization
{
    /// <summary>
    /// See:
    ...
    internal unsafe partial class Marker : global::Rosidl.Runtime.IMessage
    {
        ...
        /// <para>(originally defined as: <c><![CDATA[ınt32 id]]></c>)</para>
        /// </param>
        /// <param name='type'>
        /// Type of object.
        /// <para>(originally defined as: <c><![CDATA[ınt32 type]]></c>)</para>
        /// </param>
        /// <param name='action'>
        ...
        /// <para>(originally defined as: <c><![CDATA[ınt32 action]]></c>)</para>
        /// </param>
        /// <param name='pose'>
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public Marker(
            global::target_uav_id_publisher.Std.Header? @header = null,
            string @ns = "",
            int @id = 0,
            int @type = 0,
            int @action = 0,
            global::target_uav_id_publisher.Geometry.Pose? @pose = null,
            global::target_uav_id_publisher.Geometry.Vector3? @scale = null,
            global::target_uav_id_publisher.Std.ColorRGBA? @color = null,
            global::target_uav_id_publisher.Builtin.Duration? @lifetime = null,
            bool @frameLocked = false,
            global::target_uav_id_publisher.Geometry.Point[]? @points = null,
            global::target_uav_id_publisher.Std.ColorRGBA[]? @colors = null,
            string @textureResource = "",
            global::target_uav_id_publisher.Sensor.CompressedImage? @texture = null,
            global::target_uav_id_publisher.Visualization.UVCoordinate[]? @uvCoordinates = null,
            string @text = "",
            string @meshResource = "",
            global::target_uav_id_publisher.Visualization.MeshFile? @meshFile = null,
            bool @meshUseEmbeddedMaterials = false
        )
        {
            Header = @header ?? new global::target_uav_id_publisher.Std.Header();
            Ns = @ns;
            İd = @id;
            Type = @type;
            Action = @action;
            Pose = @pose ?? new global::target_uav_id_publisher.Geometry.Pose();
            Scale = @scale ?? new global::target_uav_id_publisher.Geometry.Vector3();
            Color = @color ?? new global::target_uav_id_publisher.Std.ColorRGBA();
            Lifetime = @lifetime ?? new global::target_uav_id_publisher.Builtin.Duration();
            FrameLocked = @frameLocked;
            Points = @points ?? global::System.Array.Empty<global::target_uav_id_publisher.Geometry.Point>();
            Colors = @colors ?? global::System.Array.Empty<global::target_uav_id_publisher.Std.ColorRGBA>();
            TextureResource = @textureResource;
            Texture = @texture ?? new global::target_uav_id_publisher.Sensor.CompressedImage();
            UvCoordinates = @uvCoordinates ?? global::System.Array.Empty<global::target_uav_id_publisher.Visualization.UVCoordinate>();
            Text = @text;
            MeshResource = @meshResource;
            MeshFile = @meshFile ?? new global::target_uav_id_publisher.Visualization.MeshFile();
        ...
        {
            this.Header = new global::target_uav_id_publisher.Std.Header(in priv.Header, textEncoding);
            ...
            this.Pose = new global::target_uav_id_publisher.Geometry.Pose(in priv.Pose, textEncoding);
            this.Scale = new global::target_uav_id_publisher.Geometry.Vector3(in priv.Scale, textEncoding);
            this.Color = new global::target_uav_id_publisher.Std.ColorRGBA(in priv.Color, textEncoding);
            this.Lifetime = new global::target_uav_id_publisher.Builtin.Duration(in priv.Lifetime, textEncoding);
            this.FrameLocked = priv.FrameLocked;
        
            this.Points = new global::target_uav_id_publisher.Geometry.Point[priv.Points.Size];
            var Points_span = priv.Points.AsSpan();
            for (int __i = 0; __i < this.Points.Length; __i++)
            {
                this.Points[__i] = new global::target_uav_id_publisher.Geometry.Point(in Points_span[__i], textEncoding);
            }
        
            this.Colors = new global::target_uav_id_publisher.Std.ColorRGBA[priv.Colors.Size];
            var Colors_span = priv.Colors.AsSpan();
            for (int __i = 0; __i < this.Colors.Length; __i++)
            {
                this.Colors[__i] = new global::target_uav_id_publisher.Std.ColorRGBA(in Colors_span[__i], textEncoding);
            }
            ...
            this.Texture = new global::target_uav_id_publisher.Sensor.CompressedImage(in priv.Texture, textEncoding);
        
            this.UvCoordinates = new global::target_uav_id_publisher.Visualization.UVCoordinate[priv.UvCoordinates.Size];
            var UvCoordinates_span = priv.UvCoordinates.AsSpan();
            for (int __i = 0; __i < this.UvCoordinates.Length; __i++)
            {
                this.UvCoordinates[__i] = new global::target_uav_id_publisher.Visualization.UVCoordinate(in UvCoordinates_span[__i], textEncoding);
            }
            ...
            this.MeshFile = new global::target_uav_id_publisher.Visualization.MeshFile(in priv.MeshFile, textEncoding);
            this.MeshUseEmbeddedMaterials = priv.MeshUseEmbeddedMaterials;
        }
        
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 ARROW = 0]]></c>
        /// </summary>
        public const int ARROW = 0;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 CUBE = 1]]></c>
        /// </summary>
        public const int CUBE = 1;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 SPHERE = 2]]></c>
        /// </summary>
        public const int SPHERE = 2;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 CYLINDER = 3]]></c>
        /// </summary>
        public const int CYLINDER = 3;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 LINE_STRIP = 4]]></c>
        /// </summary>
        public const int LINE_STRIP = 4;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 LINE_LIST = 5]]></c>
        /// </summary>
        public const int LINE_LIST = 5;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 CUBE_LIST = 6]]></c>
        /// </summary>
        public const int CUBE_LIST = 6;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 SPHERE_LIST = 7]]></c>
        /// </summary>
        public const int SPHERE_LIST = 7;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 POINTS = 8]]></c>
        /// </summary>
        public const int POINTS = 8;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 TEXT_VIEW_FACING = 9]]></c>
        /// </summary>
        public const int TEXT_VIEW_FACING = 9;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 MESH_RESOURCE = 10]]></c>
        /// </summary>
        public const int MESH_RESOURCE = 10;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 TRIANGLE_LIST = 11]]></c>
        /// </summary>
        public const int TRIANGLE_LIST = 11;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 ADD = 0]]></c>
        /// </summary>
        public const int ADD = 0;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 MODIFY = 0]]></c>
        /// </summary>
        public const int MODIFY = 0;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 DELETE = 2]]></c>
        /// </summary>
        public const int DELETE = 2;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[ınt32 DELETEALL = 3]]></c>
        /// </summary>
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Std.Header Header { get; set; }
        ...
        /// </summary>
        /// <remarks>
        /// Originally defined as: <c><![CDATA[ınt32 id]]></c>
        /// </remarks>
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        ...
        /// </summary>
        /// <remarks>
        /// Originally defined as: <c><![CDATA[ınt32 type]]></c>
        /// </remarks>
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        ...
        /// </summary>
        /// <remarks>
        /// Originally defined as: <c><![CDATA[ınt32 action]]></c>
        /// </remarks>
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Geometry.Pose Pose { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Geometry.Vector3 Scale { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Std.ColorRGBA Color { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Builtin.Duration Lifetime { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Geometry.Point[] Points { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Std.ColorRGBA[] Colors { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Sensor.CompressedImage Texture { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Visualization.UVCoordinate[] UvCoordinates { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Visualization.MeshFile MeshFile { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Points = new global::target_uav_id_publisher.Geometry.Point.PrivSequence(this.Points.Length);
            var Points_span = priv.Points.AsSpan();
            for (int __i = 0; __i < this.Points.Length; __i++)
            {
            ...
            priv.Colors = new global::target_uav_id_publisher.Std.ColorRGBA.PrivSequence(this.Colors.Length);
            var Colors_span = priv.Colors.AsSpan();
            for (int __i = 0; __i < this.Colors.Length; __i++)
            {
            ...
            priv.UvCoordinates = new global::target_uav_id_publisher.Visualization.UVCoordinate.PrivSequence(this.UvCoordinates.Length);
            var UvCoordinates_span = priv.UvCoordinates.AsSpan();
            for (int __i = 0; __i < this.UvCoordinates.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[std_msgs/msg/Header header]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Std.Header.Priv Header;
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Pose pose]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Geometry.Pose.Priv Pose;
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Vector3 scale]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Geometry.Vector3.Priv Scale;
            ...
            /// Originally defined as: <c><![CDATA[std_msgs/msg/ColorRGBA color]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Std.ColorRGBA.Priv Color;
            ...
            /// Originally defined as: <c><![CDATA[builtin_interfaces/msg/Duration lifetime]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Builtin.Duration.Priv Lifetime;
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Point[] points]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Geometry.Point.PrivSequence Points;
            ...
            /// Originally defined as: <c><![CDATA[std_msgs/msg/ColorRGBA[] colors]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Std.ColorRGBA.PrivSequence Colors;
            ...
            /// Originally defined as: <c><![CDATA[sensor_msgs/msg/CompressedImage texture]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Sensor.CompressedImage.Priv Texture;
            ...
            /// Originally defined as: <c><![CDATA[visualization_msgs/msg/UVCoordinate[] uv_coordinates]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Visualization.UVCoordinate.PrivSequence UvCoordinates;
            ...
            /// Originally defined as: <c><![CDATA[visualization_msgs/msg/MeshFile mesh_file]]></c>
            /// </summary>
            public global::target_uav_id_publisher.Visualization.MeshFile.Priv MeshFile;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Visualization.Marker.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Visualization.Marker.PrivSequence.{caller}'.");
                }
            }
        }
    }
