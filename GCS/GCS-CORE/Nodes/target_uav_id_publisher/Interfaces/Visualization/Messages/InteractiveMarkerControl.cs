...
namespace target_uav_id_publisher.Visualization
{
    ...
    internal unsafe partial class InteractiveMarkerControl : global::Rosidl.Runtime.IMessage
    {
        ...
        /// Originally defined as: <c><![CDATA[uınt8 orientation_mode]]></c>
        /// </param>
        /// <param name='interactionMode'>
        /// Originally defined as: <c><![CDATA[uınt8 interaction_mode]]></c>
        /// </param>
        ...
        public InteractiveMarkerControl(
            string @name = "",
            global::target_uav_id_publisher.Geometry.Quaternion? @orientation = null,
            byte @orientationMode = 0,
            byte @interactionMode = 0,
            bool @alwaysVisible = false,
            global::target_uav_id_publisher.Visualization.Marker[]? @markers = null,
            bool @independentMarkerOrientation = false,
            string @description = ""
        )
        {
            Name = @name;
            Orientation = @orientation ?? new global::target_uav_id_publisher.Geometry.Quaternion();
            OrientationMode = @orientationMode;
            İnteractionMode = @interactionMode;
            AlwaysVisible = @alwaysVisible;
            Markers = @markers ?? global::System.Array.Empty<global::target_uav_id_publisher.Visualization.Marker>();
            İndependentMarkerOrientation = @independentMarkerOrientation;
        ...
        public InteractiveMarkerControl(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Orientation = new global::target_uav_id_publisher.Geometry.Quaternion(in priv.Orientation, textEncoding);
            this.OrientationMode = priv.OrientationMode;
            this.İnteractionMode = priv.İnteractionMode;
            this.AlwaysVisible = priv.AlwaysVisible;
        
            this.Markers = new global::target_uav_id_publisher.Visualization.Marker[priv.Markers.Size];
            var Markers_span = priv.Markers.AsSpan();
            for (int __i = 0; __i < this.Markers.Length; __i++)
            {
                this.Markers[__i] = new global::target_uav_id_publisher.Visualization.Marker(in Markers_span[__i], textEncoding);
            }
        
            this.İndependentMarkerOrientation = priv.İndependentMarkerOrientation;
        ...
        /// </summary>
        /// <remarks>
        /// Originally defined as: <c><![CDATA[uınt8 INHERIT = 0]]></c>
        /// </remarks>
        public const byte INHERIT = 0;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[uınt8 FIXED = 1]]></c>
        /// </summary>
        public const byte FIXED = 1;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[uınt8 VIEW_FACING = 2]]></c>
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// Originally defined as: <c><![CDATA[uınt8 NONE = 0]]></c>
        /// </remarks>
        public const byte NONE = 0;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[uınt8 MENU = 1]]></c>
        /// </summary>
        public const byte MENU = 1;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[uınt8 BUTTON = 2]]></c>
        /// </summary>
        public const byte BUTTON = 2;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[uınt8 MOVE_AXIS = 3]]></c>
        /// </summary>
        public const byte MOVE_AXIS = 3;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[uınt8 MOVE_PLANE = 4]]></c>
        /// </summary>
        public const byte MOVE_PLANE = 4;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[uınt8 ROTATE_AXIS = 5]]></c>
        /// </summary>
        public const byte ROTATE_AXIS = 5;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[uınt8 MOVE_ROTATE = 6]]></c>
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// Originally defined as: <c><![CDATA[uınt8 MOVE_3D = 7]]></c>
        /// </remarks>
        public const byte MOVE_3D = 7;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[uınt8 ROTATE_3D = 8]]></c>
        /// </summary>
        public const byte ROTATE_3D = 8;
        
        /// <summary>
        /// Originally defined as: <c><![CDATA[uınt8 MOVE_ROTATE_3D = 9]]></c>
        /// </summary>
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Geometry.Quaternion Orientation { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public byte İnteractionMode { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Visualization.Marker[] Markers { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public bool İndependentMarkerOrientation { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.İnteractionMode = this.İnteractionMode;
            priv.AlwaysVisible = this.AlwaysVisible;
            
            priv.Markers = new global::target_uav_id_publisher.Visualization.Marker.PrivSequence(this.Markers.Length);
            var Markers_span = priv.Markers.AsSpan();
            for (int __i = 0; __i < this.Markers.Length; __i++)
            {
            ...
            priv.İndependentMarkerOrientation = this.İndependentMarkerOrientation;
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Quaternion orientation]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Geometry.Quaternion.Priv Orientation;
            ...
            /// Originally defined as: <c><![CDATA[visualization_msgs/msg/Marker[] markers]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Visualization.Marker.PrivSequence Markers;
            ...
            /// Originally defined as: <c><![CDATA[bool independent_marker_orientation]]></c>
            /// </remarks>
            public bool İndependentMarkerOrientation;
            ...
            public override int GetHashCode()
            {
                ...
                __hashCode.Add(this.İnteractionMode);
                __hashCode.Add(this.AlwaysVisible);
                __hashCode.Add(this.Markers);
                __hashCode.Add(this.İndependentMarkerOrientation);
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Visualization.InteractiveMarkerControl.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Visualization.InteractiveMarkerControl.PrivSequence.{caller}'.");
                }
            }
        }
    }
