...
namespace target_uav_id_publisher.Nav
{
    ...
    internal unsafe partial class GridCells : global::Rosidl.Runtime.IMessage
    {
        ...
        public GridCells(
            ...
            float @cellWidth = 0f,
            float @cellHeight = 0f,
            global::target_uav_id_publisher.Geometry.Point[]? @cells = null
        )
        {
            Header = @header ?? new global::target_uav_id_publisher.Std.Header();
            CellWidth = @cellWidth;
            CellHeight = @cellHeight;
            Cells = @cells ?? global::System.Array.Empty<global::target_uav_id_publisher.Geometry.Point>();
        }
        ...
        public GridCells(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Cells = new global::target_uav_id_publisher.Geometry.Point[priv.Cells.Size];
            var Cells_span = priv.Cells.AsSpan();
            for (int __i = 0; __i < this.Cells.Length; __i++)
            {
                this.Cells[__i] = new global::target_uav_id_publisher.Geometry.Point(in Cells_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::target_uav_id_publisher.Geometry.Point[] Cells { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Cells = new global::target_uav_id_publisher.Geometry.Point.PrivSequence(this.Cells.Length);
            var Cells_span = priv.Cells.AsSpan();
            for (int __i = 0; __i < this.Cells.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Point[] cells]]></c>
            /// </remarks>
            public global::target_uav_id_publisher.Geometry.Point.PrivSequence Cells;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Nav.GridCells.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::target_uav_id_publisher.Nav.GridCells.PrivSequence.{caller}'.");
                }
            }
        }
    }
