...
namespace node.Uniqueİdentifier
{
    /// <summary>
    ...
    internal unsafe partial class UUID : global::Rosidl.Runtime.IMessage
    {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            public global::System.Span<byte> Uuid
            {
                get
                {
                    fixed (global::node.Uniqueİdentifier.UUID.Priv* __p = &this) return new (__p->__Uuid, 16);
                }
            }
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Uniqueİdentifier.UUID.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Uniqueİdentifier.UUID.PrivSequence.{caller}'.");
                }
            }
        }
    }
