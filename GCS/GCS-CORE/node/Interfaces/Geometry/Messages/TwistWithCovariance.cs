...
namespace node.Geometry
{
    ...
    internal unsafe partial class TwistWithCovariance : global::Rosidl.Runtime.IMessage
    {
        ...
        {
            Twist = @twist ?? new global::node.Geometry.Twist();
        ...
        {
            this.Twist = new global::node.Geometry.Twist(in priv.Twist, textEncoding);
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Twist twist]]></c>
            /// </summary>
            public global::node.Geometry.Twist.Priv Twist;
            ...
            public global::System.Span<double> Covariance
            {
                get
                {
                    fixed (global::node.Geometry.TwistWithCovariance.Priv* __p = &this) return new (__p->__Covariance, 36);
                }
            }
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Geometry.TwistWithCovariance.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Geometry.TwistWithCovariance.PrivSequence.{caller}'.");
                }
            }
        }
    }
