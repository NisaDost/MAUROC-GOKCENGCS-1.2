...
namespace node.Sensor
{
    ...
    internal unsafe partial class JoyFeedbackArray : global::Rosidl.Runtime.IMessage
    {
        ...
        public JoyFeedbackArray(
            global::node.Sensor.JoyFeedback[]? @array = null
        )
        {
            Array = @array ?? global::System.Array.Empty<global::node.Sensor.JoyFeedback>();
        }
        ...
        {
            this.Array = new global::node.Sensor.JoyFeedback[priv.Array.Size];
            var Array_span = priv.Array.AsSpan();
            for (int __i = 0; __i < this.Array.Length; __i++)
            {
                this.Array[__i] = new global::node.Sensor.JoyFeedback(in Array_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::node.Sensor.JoyFeedback[] Array { get; set; }
        ...
        {
            priv.Array = new global::node.Sensor.JoyFeedback.PrivSequence(this.Array.Length);
            var Array_span = priv.Array.AsSpan();
            for (int __i = 0; __i < this.Array.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[sensor_msgs/msg/JoyFeedback[] array]]></c>
            /// </remarks>
            public global::node.Sensor.JoyFeedback.PrivSequence Array;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Sensor.JoyFeedbackArray.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Sensor.JoyFeedbackArray.PrivSequence.{caller}'.");
                }
            }
        }
    }
