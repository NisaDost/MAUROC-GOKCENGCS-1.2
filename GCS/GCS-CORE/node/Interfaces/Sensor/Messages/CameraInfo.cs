...
namespace node.Sensor
{
    ...
    internal unsafe partial class CameraInfo : global::Rosidl.Runtime.IMessage
    {
        ...
        public CameraInfo(
            ...
            uint @binningX = 0,
            uint @binningY = 0,
            global::node.Sensor.RegionOfInterest? @roi = null
        )
        {
            ...
            BinningX = @binningX;
            BinningY = @binningY;
            Roi = @roi ?? new global::node.Sensor.RegionOfInterest();
        }
        ...
        public CameraInfo(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Roi = new global::node.Sensor.RegionOfInterest(in priv.Roi, textEncoding);
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::node.Sensor.RegionOfInterest Roi { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            public global::System.Span<double> K
            {
                get
                {
                    fixed (global::node.Sensor.CameraInfo.Priv* __p = &this) return new (__p->__K, 9);
                }
            }
            ...
            public global::System.Span<double> R
            {
                get
                {
                    fixed (global::node.Sensor.CameraInfo.Priv* __p = &this) return new (__p->__R, 9);
                }
            }
            ...
            public global::System.Span<double> P
            {
                get
                {
                    fixed (global::node.Sensor.CameraInfo.Priv* __p = &this) return new (__p->__P, 12);
                }
            }
            ...
            /// Originally defined as: <c><![CDATA[sensor_msgs/msg/RegionOfInterest roi]]></c>
            /// </remarks>
            public global::node.Sensor.RegionOfInterest.Priv Roi;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Sensor.CameraInfo.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Sensor.CameraInfo.PrivSequence.{caller}'.");
                }
            }
        }
    }
