...
namespace node.Visualization
{
    ...
    internal unsafe partial class InteractiveMarker : global::Rosidl.Runtime.IMessage
    {
        ...
        public InteractiveMarker(
            ...
            string @description = "",
            float @scale = 0f,
            global::node.Visualization.MenuEntry[]? @menuEntries = null,
            global::node.Visualization.InteractiveMarkerControl[]? @controls = null
        )
        {
            ...
            Scale = @scale;
            MenuEntries = @menuEntries ?? global::System.Array.Empty<global::node.Visualization.MenuEntry>();
            Controls = @controls ?? global::System.Array.Empty<global::node.Visualization.InteractiveMarkerControl>();
        }
        ...
        public InteractiveMarker(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.MenuEntries = new global::node.Visualization.MenuEntry[priv.MenuEntries.Size];
            var MenuEntries_span = priv.MenuEntries.AsSpan();
            for (int __i = 0; __i < this.MenuEntries.Length; __i++)
            {
                this.MenuEntries[__i] = new global::node.Visualization.MenuEntry(in MenuEntries_span[__i], textEncoding);
            }
        
            this.Controls = new global::node.Visualization.InteractiveMarkerControl[priv.Controls.Size];
            var Controls_span = priv.Controls.AsSpan();
            for (int __i = 0; __i < this.Controls.Length; __i++)
            {
                this.Controls[__i] = new global::node.Visualization.InteractiveMarkerControl(in Controls_span[__i], textEncoding);
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::node.Visualization.MenuEntry[] MenuEntries { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::node.Visualization.InteractiveMarkerControl[] Controls { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.MenuEntries = new global::node.Visualization.MenuEntry.PrivSequence(this.MenuEntries.Length);
            var MenuEntries_span = priv.MenuEntries.AsSpan();
            for (int __i = 0; __i < this.MenuEntries.Length; __i++)
            {
            ...
            priv.Controls = new global::node.Visualization.InteractiveMarkerControl.PrivSequence(this.Controls.Length);
            var Controls_span = priv.Controls.AsSpan();
            for (int __i = 0; __i < this.Controls.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[visualization_msgs/msg/MenuEntry[] menu_entries]]></c>
            /// </remarks>
            public global::node.Visualization.MenuEntry.PrivSequence MenuEntries;
            ...
            /// Originally defined as: <c><![CDATA[visualization_msgs/msg/InteractiveMarkerControl[] controls]]></c>
            /// </remarks>
            public global::node.Visualization.InteractiveMarkerControl.PrivSequence Controls;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Visualization.InteractiveMarker.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Visualization.InteractiveMarker.PrivSequence.{caller}'.");
                }
            }
        }
    }
