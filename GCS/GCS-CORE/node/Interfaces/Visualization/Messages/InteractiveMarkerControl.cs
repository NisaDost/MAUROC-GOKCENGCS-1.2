...
namespace node.Visualization
{
    ...
    internal unsafe partial class InteractiveMarkerControl : global::Rosidl.Runtime.IMessage
    {
        ...
        public InteractiveMarkerControl(
            string @name = "",
            global::node.Geometry.Quaternion? @orientation = null,
            byte @orientationMode = 0,
            byte @interactionMode = 0,
            bool @alwaysVisible = false,
            global::node.Visualization.Marker[]? @markers = null,
            bool @independentMarkerOrientation = false,
            string @description = ""
        )
        {
            Name = @name;
            Orientation = @orientation ?? new global::node.Geometry.Quaternion();
            OrientationMode = @orientationMode;
            İnteractionMode = @interactionMode;
            AlwaysVisible = @alwaysVisible;
            Markers = @markers ?? global::System.Array.Empty<global::node.Visualization.Marker>();
        ...
        public InteractiveMarkerControl(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Orientation = new global::node.Geometry.Quaternion(in priv.Orientation, textEncoding);
            this.OrientationMode = priv.OrientationMode;
            this.İnteractionMode = priv.İnteractionMode;
            this.AlwaysVisible = priv.AlwaysVisible;
        
            this.Markers = new global::node.Visualization.Marker[priv.Markers.Size];
            var Markers_span = priv.Markers.AsSpan();
            for (int __i = 0; __i < this.Markers.Length; __i++)
            {
                this.Markers[__i] = new global::node.Visualization.Marker(in Markers_span[__i], textEncoding);
            }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::node.Geometry.Quaternion Orientation { get; set; }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::node.Visualization.Marker[] Markers { get; set; }
        ...
        public void WriteTo(ref Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            priv.Markers = new global::node.Visualization.Marker.PrivSequence(this.Markers.Length);
            var Markers_span = priv.Markers.AsSpan();
            for (int __i = 0; __i < this.Markers.Length; __i++)
            {
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[geometry_msgs/msg/Quaternion orientation]]></c>
            /// </remarks>
            public global::node.Geometry.Quaternion.Priv Orientation;
            ...
            /// Originally defined as: <c><![CDATA[visualization_msgs/msg/Marker[] markers]]></c>
            /// </remarks>
            public global::node.Visualization.Marker.PrivSequence Markers;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Visualization.InteractiveMarkerControl.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Visualization.InteractiveMarkerControl.PrivSequence.{caller}'.");
                }
            }
        }
    }
