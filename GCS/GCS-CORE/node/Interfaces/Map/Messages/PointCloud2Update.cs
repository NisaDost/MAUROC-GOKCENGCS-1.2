...
namespace node.Map
{
    ...
    internal unsafe partial class PointCloud2Update : global::Rosidl.Runtime.IMessage
    {
        ...
        public PointCloud2Update(
            ...
            uint @type = 0,
            global::node.Sensor.PointCloud2? @points = null
        )
        {
            Header = @header ?? new global::node.Std.Header();
            Type = @type;
            Points = @points ?? new global::node.Sensor.PointCloud2();
        }
        ...
        public PointCloud2Update(in Priv priv, global::System.Text.Encoding textEncoding)
        {
            ...
            this.Type = priv.Type;
            this.Points = new global::node.Sensor.PointCloud2(in priv.Points, textEncoding);
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ros2cs", "1.3.2+da40d8cd913b1d7f1523f4fd2ce6a86ea7d47c2e")]
        public global::node.Sensor.PointCloud2 Points { get; set; }
        ...
        public partial struct Priv : global::System.IEquatable<Priv>, global::System.IDisposable
        {
            ...
            /// Originally defined as: <c><![CDATA[sensor_msgs/msg/PointCloud2 points]]></c>
            /// </summary>
            public global::node.Sensor.PointCloud2.Priv Points;
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Map.PointCloud2Update.Priv.{caller}'.");
                }
            }
        }
        ...
        public partial struct PrivSequence : global::System.IEquatable<PrivSequence>, global::System.IDisposable
        {
            ...
            string caller = "")
            {
                if (!ret)
                {
                    throw new global::Rosidl.Runtime.RosidlException($"An error occurred when calling 'global::node.Map.PointCloud2Update.PrivSequence.{caller}'.");
                }
            }
        }
    }
